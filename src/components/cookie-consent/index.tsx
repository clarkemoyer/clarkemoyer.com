...
export default function CookieConsent() {
  ...
  const [savedPreferencesBackup, setSavedPreferencesBackup] = useState<CookiePreferences>({
    necessary: true,
    analytics: false,
    marketing: false,
  })
  ...
  const applyConsent = useCallback((prefs: CookiePreferences) => {
    ...
    // Future: conditionally load GA/Clarity/Meta Pixel based on prefs here
  }, [])
  ...
  useEffect(() => {
    if (showPreferences && modalRef.current) {
      ...
      const handleEscape = (e: KeyboardEvent) => {
        if (e.key === 'Escape') handleCancelPreferences()
      }
  ...
  if (showPreferences) {
    return (
      <div
        ...
        onClick={(e) => {
          if (e.target === e.currentTarget) handleCancelPreferences()
        }}
      >
        <div
          ref={modalRef}
        ...
        >
          <div className="p-6">
            <h2 id="cookie-prefs-title" className="text-2xl font-bold text-gray-900 mb-4">
              Cookie Preferences
            </h2>
            ...
            <div className="mb-4 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Essential for the site to function. Includes your cookie preference storage.
              </p>
            </div>
            ...
            <div className="mb-4 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Help understand how visitors use the site (e.g. Google Analytics, Microsoft Clarity).
              </p>
            </div>
            ...
            <div className="mb-4 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Used for retargeting and advertising (e.g. Meta Pixel).
              </p>
            </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mb-3">
              We use cookies to improve your experience and analyze traffic. You can accept all,
