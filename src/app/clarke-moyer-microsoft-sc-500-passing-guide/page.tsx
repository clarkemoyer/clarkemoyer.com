        ...
        <div className="max-w-4xl mx-auto px-4 prose prose-lg">
          ...
          <div className="not-prose bg-amber-50 border-l-4 border-amber-500 p-5 mb-6">
            <p className="text-amber-800 text-sm">
              Clarke holds this certification and keeps it active as Microsoft evolves the cloud security
              track. The SC-500 is a relatively new exam — objectives may be updated; always verify at{' '}
