...
- Name: smoke.spec.ts >> Smoke — page titles >> /professional-development/ has a title containing "Clarke Moyer"
- Location: tests/smoke.spec.ts:48:5

# Error details

```
Error: /professional-development/ title: "404: This page could not be found."
