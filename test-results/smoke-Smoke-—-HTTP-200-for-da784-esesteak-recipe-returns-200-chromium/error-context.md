...
- Name: smoke.spec.ts >> Smoke — HTTP 200 for all pages >> /clarke-moyer-philly-cheesesteak-recipe/ returns 200
- Location: tests/smoke.spec.ts:38:5

# Error details

```
Error: /clarke-moyer-philly-cheesesteak-recipe/ should return 200
