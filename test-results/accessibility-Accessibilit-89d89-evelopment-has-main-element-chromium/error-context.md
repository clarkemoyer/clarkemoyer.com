...
- Name: accessibility.spec.ts >> Accessibility — every page has <main> and <h1> >> /professional-development/ has <main> element
- Location: tests/accessibility.spec.ts:27:5

# Error details

```
Error: /professional-development/ missing <main>
