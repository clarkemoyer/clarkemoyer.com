...
- Name: consulting.spec.ts >> Walk and Talk consulting page >> has link to freeforcharity.org
- Location: tests/consulting.spec.ts:30:3
...
Locator: locator('a[href*="freeforcharity.org"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href*="freeforcharity.org"]').first()
