...
- Name: accessibility.spec.ts >> Accessibility — breadcrumb aria-label >> /clarke-moyer-world-famous-apple-crisp-recipe/ breadcrumb has aria-label="Breadcrumb"
- Location: tests/accessibility.spec.ts:43:5

# Error details

```
Error: /clarke-moyer-world-famous-apple-crisp-recipe/ missing aria-label="Breadcrumb"
