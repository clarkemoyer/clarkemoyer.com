...
- Name: accessibility.spec.ts >> Accessibility — external links on Walk and Talk page >> all external links have target="_blank" and rel containing "noopener"
- Location: tests/accessibility.spec.ts:63:3
