...
- Name: accessibility.spec.ts >> Accessibility — breadcrumb aria-label >> /clarke-moyer-mcp-passing-guide/ breadcrumb has aria-label="Breadcrumb"
- Location: tests/accessibility.spec.ts:43:5

# Error details

```
Error: /clarke-moyer-mcp-passing-guide/ missing aria-label="Breadcrumb"
