...
- Name: professional-development.spec.ts >> /professional-development/ >> has "KubeCon" in content
- Location: tests/professional-development.spec.ts:13:3
