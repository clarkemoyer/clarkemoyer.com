...
- Name: accessibility.spec.ts >> Accessibility — breadcrumb aria-label >> /clarke-moyer-cissp-certification-passing-guide/ breadcrumb has aria-label="Breadcrumb"
- Location: tests/accessibility.spec.ts:43:5

# Error details

```
Error: /clarke-moyer-cissp-certification-passing-guide/ missing aria-label="Breadcrumb"
