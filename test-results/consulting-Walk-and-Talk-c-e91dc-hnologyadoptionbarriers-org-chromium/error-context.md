...
- Name: consulting.spec.ts >> Walk and Talk consulting page >> has link to technologyadoptionbarriers.org
- Location: tests/consulting.spec.ts:35:3
...
Locator: locator('a[href*="technologyadoptionbarriers.org"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href*="technologyadoptionbarriers.org"]').first()
