...
- Name: professional-development.spec.ts >> /professional-development/ >> has section headings for all 4 professional categories
- Location: tests/professional-development.spec.ts:33:3

# Error details

```
Error: Expected conferences section
