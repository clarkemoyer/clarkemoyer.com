...
- Name: smoke.spec.ts >> Smoke — page titles >> /clarke-moyer-vcp6-cma-passing-guide/ has a title containing "Clarke Moyer"
- Location: tests/smoke.spec.ts:48:5

# Error details

```
Error: /clarke-moyer-vcp6-cma-passing-guide/ title: ""
