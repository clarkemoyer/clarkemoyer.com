...
- Name: accessibility.spec.ts >> Accessibility — every page has <main> and <h1> >> /personal-project-manager/ has <main> element
- Location: tests/accessibility.spec.ts:27:5

# Error details

```
Error: /personal-project-manager/ missing <main>
    ...
    - generic [ref=e5]:
      - generic [ref=e6]:
        - link "Home" [ref=e7] [cursor=pointer]:
          - /url: /
        - text: / Personal Project Manager
      - heading "Personal Project Manager" [level=1] [ref=e8]
    - generic [ref=e10]:
      - paragraph [ref=e11]: Content for this page is coming soon. Check back later for tools and resources on personal project management.
      - link "← Back to Home" [ref=e12] [cursor=pointer]:
        - /url: /
  - alert [ref=e13]
  - region "Cookie consent notice" [ref=e14]:
    - generic [ref=e16]:
      - generic [ref=e17]:
        - heading "We Value Your Privacy" [level=3] [ref=e18]
        - paragraph [ref=e19]: We use cookies to improve your experience and analyze traffic. You can accept all, decline non-essential cookies, or customize your preferences.
        - generic [ref=e20]:
          - link "Privacy Policy" [ref=e21] [cursor=pointer]:
            - /url: /privacy-policy/
          - link "Cookie Policy" [ref=e22] [cursor=pointer]:
            - /url: /cookie-policy/
      - generic [ref=e23]:
        - button "Decline All" [ref=e24]
        - button "Customize" [ref=e25]
        - button "Accept All" [ref=e26]
```
