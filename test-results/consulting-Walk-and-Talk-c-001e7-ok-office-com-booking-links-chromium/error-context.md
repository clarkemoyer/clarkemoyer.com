...
- Name: consulting.spec.ts >> Walk and Talk consulting page >> has at least 2 outlook.office.com booking links
- Location: tests/consulting.spec.ts:40:3

# Error details

```
Error: Expected at least 2 booking links
