...
- Name: professional-development.spec.ts >> /professional-development/ >> has "IEEE" in content
- Location: tests/professional-development.spec.ts:25:3
